...
var AuthService = /** @class */ (function () {
    function AuthService(prisma, usersService, jwtService) {
        this.prisma = prisma;
    ...
    AuthService.prototype.register = function (registerDto) {
        return __awaiter(this, void 0, void 0, function () {
            var email, password, nombre, existingUser, passwordHash, user, token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        email = registerDto.email, password = registerDto.password, nombre = registerDto.nombre;

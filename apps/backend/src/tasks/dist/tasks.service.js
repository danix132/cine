...
var TasksService = /** @class */ (function () {
    function TasksService(carritosService) {
        this.carritosService = carritosService;
        this.logger = new common_1.Logger(TasksService_1.name);
    }
    TasksService_1 = TasksService;
    TasksService.prototype.limpiarCarritosExpirados = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.carritosService.limpiarCarritosExpirados()];
                    case 1:
                        resultado = _a.sent();
                    ...
                    case 2:
                        error_1 = _a.sent();
                        this.logger.error('Error al limpiar carritos expirados:', error_1);
                        return [3 /*break*/, 3];
    ...
    TasksService.prototype.limpiarLogsAntiguos = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
    ...
    ], TasksService.prototype, "limpiarCarritosExpirados");
    __decorate([
        schedule_1.Cron(schedule_1.CronExpression.EVERY_DAY_AT_MIDNIGHT)
    ], TasksService.prototype, "limpiarLogsAntiguos");
